  ...
  return (
    <section className="bg-[#f8fafc] px-4 py-12 sm:px-8 sm:py-16">
      ...
      >
              ...
              <section>
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-3">
                  {item.gallery.map((image, index) => (
                    <div
                      className="group relative aspect-[4/3] overflow-hidden rounded-xl bg-[#0f172a]"
        ...
        {!isPayment ? (
          <aside className="overflow-hidden rounded-2xl border border-[#0f172a]/10 bg-white shadow-[0_20px_50px_rgba(23,33,31,0.10)] lg:sticky lg:top-28">
          ...
          <div className="p-5">
            <div className="rounded-xl border border-[#0f172a]/10 bg-[#f8fafc] p-5">
...
function ImportantNotes() {
  return (
    <section className="rounded-2xl border border-[#0f172a]/10 bg-white p-6 shadow-sm">
    ...
    <section>
      ...
      >
        {items.map((item, index) => (
          <li
            className={`group rounded-xl border border-[#0f172a]/8 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${
              ordered

...
export const metadata: Metadata = {
  title: "Cancellation Policy | CrystalTourAndTravel",
  description:
    "Cancellation policy for CrystalTourAndTravel bookings, itinerary changes, no-shows, supplier penalties, and travel credits.",
};
...
const sections = [
  ...
  },
  {
    ...
    body: [
      "Cancellation charges may include airline penalties, hotel penalties, tour operator penalties, transfer charges, visa or document fees, payment processor fees, taxes, currency conversion differences, and CrystalTourAndTravel service fees.",
      ...
      <section className="px-4 py-14 sm:px-8 sm:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-8 text-lg leading-8 text-[#475569]">
            ...
            bookings arranged through CrystalTourAndTravel.
          </p>
        </div>
      </section>

...
export const metadata: Metadata = {
  title: "Privacy Policy | CrystalTourAndTravel",
  description:
    "Privacy policy for CrystalTourAndTravel covering inquiries, payments, travel documents, and customer communications.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <PolicyPage
      ...
      intro="This Privacy Policy explains how CrystalTourAndTravel collects, uses, shares, and protects information when you visit our website, request travel services, make payments, or communicate with us."
      sections={sections}
    />
  );
}

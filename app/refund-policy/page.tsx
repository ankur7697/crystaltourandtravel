...
export const metadata: Metadata = {
  title: "Refund Policy | CrystalTourAndTravel",
  description:
    "Refund policy for CrystalTourAndTravel bookings, deposits, supplier charges, payment processing, and travel service fees.",
};
      ...
      <section className="px-4 py-14 sm:px-8 sm:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-8 text-lg leading-8 text-[#475569]">
            ...
            related services booked through CrystalTourAndTravel.
          </p>
        </div>
      </section>
